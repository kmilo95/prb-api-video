...
- 🎯 Entry points to execute your program using `python -m <prb_api_video>` or `$ prb_api_video` with basic CLI argument parsing.
...
---
# prb_api_video Flask Application

Awesome prb_api_video created by kmilo95
...
```bash
prb_api_video create-db   # run once
prb_api_video populate-db  # run once (optional)
prb_api_video add-user -u admin -p 1234  # ads a user
prb_api_video run
```
